...
diff = 1; 
while (diff>0.001 & daysToStSt<150)   % criterion for convergence (and criterion for bailing out of overproduction scenarios)
    % run day n+1
    ...
    % remove Rab7 elements (because these don't converge!)
        Rab7elements = [77:83 147:157 206:229 254:273 278:281];
...
tend = toc(tstart);
 ...
 %simtoststdetails = table(daysToStSt,tend, diff, index)
