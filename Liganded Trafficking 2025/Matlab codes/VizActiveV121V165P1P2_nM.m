function activeFig = VizActiveV121V165P1P2_nM(Routs,vals121,vals165,valsP1,valsP2, yaxistitle,figname,ngml,visibility,ligandmap)
...
for j = 1:length(ngml)
	...
	aP1  = [aP1 eval(strcat("Routs(j+2*length(ngml)).",valsP1,"(15+1)"))];
    aP2  = [aP2 eval(strcat("Routs(j+3*length(ngml)).",valsP2,"(15+1)"))];
	b121 = [b121 eval(strcat("Routs(j).",vals121,"(60+1)"))];
    b165 = [b165 eval(strcat("Routs(j+length(ngml)).",vals165,"(60+1)"))];
	bP1  = [bP1 eval(strcat("Routs(j+2*length(ngml)).",valsP1,"(60+1)"))];
    bP2  = [bP2 eval(strcat("Routs(j+3*length(ngml)).",valsP2,"(60+1)"))];
	c121 = [c121 eval(strcat("Routs(j).",vals121,"(240+1)"))];
    c165 = [c165 eval(strcat("Routs(j+length(ngml)).",vals165,"(240+1)"))];
	cP1  = [cP1 eval(strcat("Routs(j+2*length(ngml)).",valsP1,"(240+1)"))];
    cP2  = [cP2 eval(strcat("Routs(j+3*length(ngml)).",valsP2,"(240+1)"))];
end
